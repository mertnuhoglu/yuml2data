...
mkdir -p rdb/view
find schema/yuml | ack 'data_model|datamodel' | ack '\.md' | xargs cat > rdb/view/datamodel_sdb_p01.yuml
dos2unix rdb/view/datamodel_sdb_p01.yuml

cd "${SCRIPT_DIR}"
./convert_yuml_markdown_2_clean_yuml.sh "${DATA_MODEL_DIR}/rdb/view/datamodel_sdb_p01.yuml"
#vim -c "ConvertYumlMarkdown2CleanYuml" -c wq rdb/view/datamodel_sdb.yuml
vim -S YumlFixFormat.vim -c "YumlFixFormat" -c "w! ${DATA_MODEL_DIR}/rdb/view/datamodel_sdb.yuml" -c 'q!' "${DATA_MODEL_DIR}/rdb/view/datamodel_sdb_p01.yuml"
